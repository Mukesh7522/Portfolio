...
const skillCategories = [
  {
    ...
    skills: [
      'SQL: Advanced joins, CTEs, window functions, indexing',
      'PostgreSQL, MySQL',
      'Excel: Advanced (Pivot Tables, Power Query, XLOOKUP)',
      'Odoo ERP',
  ...
  },
  {
    ...
    title: 'ETL & Pipelines',
    skills: [
      'Python: Pandas, SQL orchestration scripting, ETL automation',
      'Data Pipelines: Automated ingestion, validation, reconciliation',
  ...
  },
  {
    ...
    skills: [
      'Power BI: DAX, Power Query (M), semantic modeling',
      'Tableau',
