...
const projects = [
  ...
  },
  {
    ...
    features: [
      'Engineered in 5 days for 10+ staff handling 300+ orders with automated order capture',
      'Reduced orderdocumentation time by 85% (12 min → 2 min per order)',
      'Real-time inventory visibility via Excel/Dropbox sync with automatic Order ID generation',
    ],
    company: 'Technosport',
    isPublic: false,
  },
